...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.uneed.yuni_widget.YuniWidgetPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin yuni_widget, com.uneed.yuni_widget.YuniWidgetPlugin", e);
    }
  }
}
